...
class REH_API {
        ...
        if ( $site && 'all' !== $site && 'group' !== $site ) {
            $args['tax_query'] = array(
                array(
                    'taxonomy' => REH_Post_Types::LOCATION_TAXONOMY,
                    'field'    => 'slug',
                    'terms'    => array_unique( array( $site, self::community_events_slug() ) ),
                ),
            );
        }
    ...
    protected static function community_events_slug() {
        return apply_filters( 'reh/community_events_slug', 'community-events' );
    }
